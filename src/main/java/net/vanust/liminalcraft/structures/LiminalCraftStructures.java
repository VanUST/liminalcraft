package net.vanust.liminalcraft.structures;
...
public class LiminalCraftStructures {
...
//                instance.group(BaseStructure.settingsCodec(instance),
...
//                ).apply(instance, BaseStructure::new)).codec();
//
...
//
//        public BaseStructures(Structure.StructureSettings config,
...
//            return LiminalCraftStructureRegister.BASE_STRUCTURE.get(); // Helps the game know how to turn this structure back to json to save to chunks
//        }
//    }
}