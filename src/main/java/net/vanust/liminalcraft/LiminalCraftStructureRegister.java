...
public class LiminalCraftStructureRegister {
     ...
     */
    public static final RegistryObject<StructureType<BaseStructure>> BASE_STRUCTURE = DEFERRED_REGISTRY_STRUCTURE.register("base_structure", () -> explicitStructureTypeTyping(BaseStructure.CODEC));
