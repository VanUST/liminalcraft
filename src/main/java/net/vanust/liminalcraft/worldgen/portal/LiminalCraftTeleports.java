...
public class LiminalCraftTeleports implements ITeleporter {
    ...
    public LiminalCraftTeleports(BlockPos pos, boolean insideDim) {
        thisPos = pos;
    ...
    public Entity placeEntity(Entity entity, ServerLevel currentWorld, ServerLevel destinationWorld,
        ...
        if (insideDimension) {
            ...
            if (doSetBlock) {
                destinationWorld.setBlock(destinationPos, LiminalCraftBlocks.LEVEL_0_PORTAL.get().defaultBlockState(), 3);
            }
        }
